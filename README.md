...
| Blog post shared to social media | Reads your blog RSS feed and schedules a social post (with the article image) across your connected accounts via Posta. | Marketing/Social Media | [Link to Template](Instagram_Twitter_Social_Media/Blog%20post%20shared%20to%20social%20media.json) |
| Create LinkedIn carousel post from blog post | Summarizes a new blog post into a 5-slide LinkedIn carousel PDF — AI text (DeepSeek) over AI backgrounds (fal.ai), assembled by Posta. | Marketing/Social Media/AI | [Link to Template](Instagram_Twitter_Social_Media/Create%20LinkedIn%20carousel%20post%20from%20blog%20post.json) |
| E-commerce product launch campaign | Turns a product into a 5-day, multi-platform launch campaign with per-platform captions written by AI, scheduled via Posta. | Marketing/E-commerce/AI | [Link to Template](Instagram_Twitter_Social_Media/E-commerce%20product%20launch%20campaign.json) |
| YouTube video to social media promotion | Reads your YouTube feed, grabs the latest video and thumbnail, and drafts AI-written promo posts across every platform via Posta. | Marketing/Social Media/AI | [Link to Template](Instagram_Twitter_Social_Media/YouTube%20video%20to%20social%20media%20promotion.json) |
