...
| Title | Description | Department | Link |
|-------|-------------|------------|------|
| Free Invoice Reminder Workflow — Google Sheets to Email | Reads an invoice tracker in Google Sheets, filters unpaid invoices due soon, sends reminder emails, and marks reminders as sent. | Finance / Ops | [Link to Template](Google_Drive_and_Google_Sheets/Free%20Invoice%20Reminder%20Workflow%20-%20Google%20Sheets%20to%20Email.json) |
