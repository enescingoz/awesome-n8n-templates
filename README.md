...
| AI Video Render QC Gate | Webhook-triggered quality gate for AI video generation pipelines. Runs ffprobe on each finished render and scores it against your delivery contract (minimum duration, resolution, frame rate), returning a pass/fail verdict with the exact violation reasons. Self-hosted and offline: no external API keys required. | Engineering/AI | [Link to Template](OpenAI_and_LLMs/AI%20Video%20Render%20QC%20Gate.json) |
