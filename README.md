...
| Monitor X Search with Xquik | Runs X/Twitter search with Xquik, preserves pagination and engagement fields, and builds an email-ready social listening digest. Uses an n8n Header Auth credential to keep the API key out of the workflow JSON. | Marketing/Analytics | [Link to Template](Instagram_Twitter_Social_Media/Monitor%20X%20Search%20with%20Xquik.json) |
